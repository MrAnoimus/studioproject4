...
void CResultState::KeyboardDown(unsigned char key, int x, int y)
{
	myKeys[key]= true;
	cout<<"Key: "<<key<<" STATE : " <<myKeys[key]<<endl;
}

void CResultState::KeyboardUp(unsigned char key, int x, int y)
{
	myKeys[key]= false;
	cout<<"Key: "<<key<<" STATE : " <<myKeys[key]<<endl;
}
void CResultState::MouseMove(int x , int y)
{
...
bool CResultState::Init()
{
	cout << "CResultState::Init\n" << endl;
...
void CResultState::Pause()
{
	//cout << "CResultState::Pause\n" << endl;
}

void CResultState::Resume()
{
	//cout << "CResultState::Resume\n" << endl;
}

void CResultState::HandleEvents(CGameStateManager* theGSM)
{
...
void CResultState::Update(CGameStateManager* theGSM)
{
...
void CResultState::Draw(CGameStateManager* theGSM) 
{
...
void CResultState::calculateFPS()
{
...
bool CResultState::LoadTGA(TextureImage *texture, char *filename)			// Loads A TGA File Into Memory
{    
